 ...
 * Main entry point for the Trust Score calculation service
 */
...
// Initialize Trust Scorer Service
...
// Configure routes
configureRoutes(app, trustScorer, logger);

// Start server
const PORT = process.env.PORT || 3100;
app.listen(PORT, () => {
  logger.info(`Trust Scorer Service running on port ${PORT}`);
});
